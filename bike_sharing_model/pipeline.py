...
titanic_pipe=Pipeline([
    ...
    ("embark_imputation", embarkImputer(variables=config.model_config.embarked_var)),
     ...
     ('model_rf', RandomForestClassifier(n_estimators=config.model_config.n_estimators, max_depth=config.model_config.max_depth,random_state=config.model_config.random_state))
     ])